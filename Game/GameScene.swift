...
//        addChild(background)
        ...
        addChild(princess)
                ...
                walkFrames = [
                    SKTexture(imageNamed: "phase1"),
                    SKTexture(imageNamed: "phase2"),
                    SKTexture(imageNamed: "phase3"),
                    SKTexture(imageNamed: "phase4"),
                    SKTexture(imageNamed: "phase5"),
                    SKTexture(imageNamed: "phase6")
                ]
        ...
        dialogueBox.position = CGPoint(x: -150, y: -120)
